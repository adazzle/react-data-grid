              ...
              <li className="dropdown">
                <a href="#" className="dropdown-toggle" data-toggle="dropdown">Examples <b className="caret"></b></a>
                  <ul className="dropdown-menu">
                    ...
                    <li><a href="examples.html#/auto-edit">Auto Edit Grid</a></li>
                    ...
                    <li><a href="examples.html#/all-features-immutable">All-The-Features with Immutable Data</a></li>
                    <li><a href="examples.html#/single-select-grid">Single Row Select</a></li>
                    </ul>
                </li>
            </ul>
          </div>
