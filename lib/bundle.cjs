...
function DataGrid(props, ref) {
	...
	*/
	...
	const [selectedRange, setSelectedRange] = (0, react.useState)(initialSelectedRange);
	const [copiedRange, setCopiedRange] = (0, react.useState)(null);
	const [isMouseRangeSelectionMode, setIsMouseRangeSelectionMode] = (0, react.useState)(false);
	/**
	* refs
	*/
...
Object.defineProperty(exports, 'renderHeaderCell', {
  enumerable: true,
  get: function () {
