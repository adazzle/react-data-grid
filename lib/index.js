...
function DataGrid(props) {
	...
	*/
	...
	function getCellEditor(rowIdx) {
		...
		if (selectedRange.endRowIdx - selectedRange.startRowIdx > 0 || selectedRange.endColumnIdx - selectedRange.startColumnIdx > 0) return;
