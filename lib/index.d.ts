...
declare function TreeDataGrid<R, SR = unknown, K extends Key = Key>({
  ...
  ...props
}: TreeDataGridProps<R, SR, K>): react_jsx_runtime6.JSX.Element;
//#endregion
...
declare function renderCheckbox({
  ...
  indeterminate,
  ...props
}: RenderCheckboxProps): react_jsx_runtime6.JSX.Element;
//#endregion
//#region src/cellRenderers/renderToggleGroup.d.ts
declare function renderToggleGroup<R, SR>(props: RenderGroupCellProps<R, SR>): react_jsx_runtime6.JSX.Element;
declare function ToggleGroup<R, SR>({
  groupKey,
  isExpanded,
  tabIndex,
  toggleGroup
}: RenderGroupCellProps<R, SR>): react_jsx_runtime6.JSX.Element;
//#endregion
