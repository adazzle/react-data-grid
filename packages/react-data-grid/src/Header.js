...
class Header extends React.Component {
  ...
  shouldComponentUpdate(nextProps: any, nextState: any): boolean {
    let update =
      !ColumnMetrics.sameColumns(
        ...
        nextProps.columnMetrics.columns,
        ColumnMetrics.sameColumn,
  ...
  onColumnResize = (column: Column, width: number) => {
    ...
    if (pos != null) {
      ...
      resizing.column = ColumnUtils.getColumn(
        resizing.columnMetrics.columns,
        pos
      );
  ...
  getHeaderRows = (): Array<HeaderRow> => {
    ...
    this.props.headerRows.forEach((row, index) => {
      ...
      let updatedWidth = isNaN(this.props.totalWidth - scrollbarSize)
