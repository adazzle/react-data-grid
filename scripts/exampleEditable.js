...
var ReactDataGrid = require('../build/ReactDataGrid');
...
var EditableGrid = React.createClass({
  ...
  render : function(): ?ReactElement {
    return(<ReactDataGrid rows={this.state.rows} columns={columns} enableCellSelect={true} onRowUpdated={this.handleRowUpdated}></ReactDataGrid>);
  }
});
