...
})(this, function(__WEBPACK_EXTERNAL_MODULE_1__, __WEBPACK_EXTERNAL_MODULE_295__) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactDataGrid = __webpack_require__(296);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $def = __webpack_require__(21);
	$def($def.S, 'Object', { setPrototypeOf: __webpack_require__(243).set });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Object$setPrototypeOf = __webpack_require__(240)['default'];
	...
	module.exports = {
	  ...
	  ? (function (buggy, set) {
	    try {
	      set = __webpack_require__(244)(Function.call, getDesc(Object.prototype, '__proto__').set, 2);
	      set({}, []);
	    } catch (e) {
	      buggy = true;
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var faker = __webpack_require__(295);
	faker.locale = 'en_GB';
	var SIZE = 2000;
	var _cache = [];
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(true){!(__WEBPACK_AMD_DEFINE_ARRAY__ = [],__WEBPACK_AMD_DEFINE_RESULT__ = (function(){return classNames;}).apply(exports,__WEBPACK_AMD_DEFINE_ARRAY__),__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));} /***/}, /* 21 */function(module,exports){ /**
		 ...
		 */"use strict";var _Object$assign=__webpack_require__(3)['default'];var shallowCloneObject=__webpack_require__(21);var isValidElement=__webpack_require__(17).isValidElement;var sameColumn=__webpack_require__(23);var ColumnUtils=__webpack_require__(24); /**
	...
	return cloneWithProps(customEditor,editorProps);}else {return React.createElement(SimpleTextEditor,{ref:editorRef,column:this.props.column,onKeyDown:this.onKeyDown,value:this.getInitialValue(),onBlur:this.commit,rowMetaData:this.getRowMetaData()});}},getRowMetaData:function getRowMetaData(){ //clone row data so editor cannot actually change this
	var columnName=this.props.column.ItemId; //convention based method to get corresponding Id or Name of any Name or Id property
	...
	return valid;},isKeyExplicitlyHandled:function isKeyExplicitlyHandled(key){return typeof this['onPress' + key] === 'function';},isCtrlKeyHeldDown:function isCtrlKeyHeldDown(e){return e.ctrlKey === true && e.key !== "Control";},checkAndCall:function checkAndCall(methodName,args){if(typeof this[methodName] === 'function'){this[methodName](args);}}};module.exports = KeyboardHandlerMixin; /***/}, /* 53 */function(module,exports,__webpack_require__){ /**
		 ...
		 */'use strict';var _get=__webpack_require__(54)['default'];var _inherits=__webpack_require__(60)['default'];var _createClass=__webpack_require__(71)['default'];var _classCallCheck=__webpack_require__(41)['default'];var React=__webpack_require__(17);var keyboardHandlerMixin=__webpack_require__(52);var ExcelColumn=__webpack_require__(40);var EditorBase=__webpack_require__(74);var SimpleTextEditor=(function(_EditorBase){_inherits(SimpleTextEditor,_EditorBase);function SimpleTextEditor(){_classCallCheck(this,SimpleTextEditor);_get(Object.getPrototypeOf(SimpleTextEditor.prototype),'constructor',this).apply(this,arguments);}_createClass(SimpleTextEditor,[{key:'render',value:function render(){return React.createElement('input',{ref:'input',type:'text',onBlur:this.props.onBlur,className:'form-control',defaultValue:this.props.value,onKeyDown:this.props.onKeyDown});}}]);return SimpleTextEditor;})(EditorBase);;module.exports = SimpleTextEditor; /***/}, /* 54 */function(module,exports,__webpack_require__){"use strict";var _Object$getOwnPropertyDescriptor=__webpack_require__(55)["default"];exports["default"] = function get(_x,_x2,_x3){var _again=true;_function: while(_again) {var object=_x,property=_x2,receiver=_x3;desc = parent = getter = undefined;_again = false;if(object === null)object = Function.prototype;var desc=_Object$getOwnPropertyDescriptor(object,property);if(desc === undefined){var parent=Object.getPrototypeOf(object);if(parent === null){return undefined;}else {_x = parent;_x2 = property;_x3 = receiver;_again = true;continue _function;}}else if("value" in desc){return desc.value;}else {var getter=desc.get;if(getter === undefined){return undefined;}return getter.call(receiver);}}};exports.__esModule = true; /***/}, /* 55 */function(module,exports,__webpack_require__){module.exports = {"default":__webpack_require__(56),__esModule:true}; /***/}, /* 56 */function(module,exports,__webpack_require__){var $=__webpack_require__(15);__webpack_require__(57);module.exports = function getOwnPropertyDescriptor(it,key){return $.getDesc(it,key);}; /***/}, /* 57 */function(module,exports,__webpack_require__){ // 19.1.2.6 Object.getOwnPropertyDescriptor(O, P)
