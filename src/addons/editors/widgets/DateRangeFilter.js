...
DateRangePicker.prototype = {
		...
		buildCalendar(month, year, hour, minute) {
		...
		renderDropdowns(selected, minDate, maxDate) {
		...
		renderCalendar(calendar, selected, minDate, maxDate) {
...
var validateDate = function(props, propName) {
