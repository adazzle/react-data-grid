...
describe('getHorizontalRangeToRender', () => {
  function getColumnMetrics(): ColumnMetrics<Row, never> {
  ...
  function getRange<K extends keyof HorizontalRangeToRenderParams<Row, never>>(overrides: Pick<HorizontalRangeToRenderParams<Row, never>, K>) {
